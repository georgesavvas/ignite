...
class SubmitRFE(QWidget):
    def __init__(self, hda_name="HDA", labels=[], parent=None):
        super(SubmitRFE, self).__init__(parent)
        ...
        self.setWindowTitle(hda_name + " - Request for Enhancement")
    ...
    def submit_form(self):
        ...
        PROJECT.issues.create(
            {"title": title, "description": description, "labels": self.labels}
        )

        hou.ui.displayMessage("RFE submitted successfully, thank you!")
        self.close()
