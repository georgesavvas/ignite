...
CMDS = {
    ...
    "Darwin": "pyinstaller --hidden-import=timeago.locales.en src/python/ignite/main.py --noconfirm --windowed --onefile --codesign-identity=$MACOS_CERTIFICATE_NAME --osx-entitlements-file=./entitlements.plist --deep --name=IgniteBackend --icon=../frontend/public/media/desktop_icon/mac/icon.icns",
