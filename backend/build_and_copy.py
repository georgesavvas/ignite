...
CMDS = {
    ...
    "Darwin": "pyinstaller --hidden-import=timeago.locales.en src/python/ignite/main.py --noconfirm --windowed --onefile --codesign-identity=\"Developer ID Application: Georgios Savvas (AJ25U37XWA)\" --osx-entitlements-file=./entitlements.plist --name=IgniteBackend --icon=../frontend/public/media/desktop_icon/mac/icon.icns",
