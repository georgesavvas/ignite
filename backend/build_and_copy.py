...
CMDS = {
    ...
    "Darwin": "pyinstaller --hidden-import=timeago.locales.en src/python/ignite/main.py --noconfirm --windowed --onefile --name=IgniteBackend --icon=../frontend/public/media/desktop_icon/mac/icon.icns",
